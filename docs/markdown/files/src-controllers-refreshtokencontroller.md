...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">RefreshTokenController.php
--------------------------

###  Table of Contents [](files/src-controllers-refreshtokencontroller.html#toc)

####  Classes [](files/src-controllers-refreshtokencontroller.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Controllers\RefreshTokenController">RefreshTokenController</abbr>](classes/NPR-One-Controllers-RefreshTokenController.html)</dt><dd>This controller should always be used by every consumer, regardless of whether you are using the `authorization\_code` or `device\_code` grant types. Use this to generate a new access token when a previously-generated token has expired.</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-controllers-refreshtokencontroller.html#top) </main> <script>
        cssVars({});
