...
- [One](packages/NPR-One.html)
 ...
 <article class="phpdocumentor-element -package">Exceptions
----------

###  Table of Contents [](packages/NPR-One-Exceptions.html#toc)

####  Classes [](packages/NPR-One-Exceptions.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Exceptions\ApiException">ApiException</abbr>](classes/NPR-One-Exceptions-ApiException.html)</dt><dd>An extension of CookieProvider that encrypts cookies before setting them and decrypts them when retrieving them</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](packages/NPR-One-Exceptions.html#top) </main> <script>
        cssVars({});
