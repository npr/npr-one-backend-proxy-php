...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">LogoutController.php
--------------------

###  Table of Contents [](files/src-controllers-logoutcontroller.html#toc)

####  Classes [](files/src-controllers-logoutcontroller.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Controllers\LogoutController">LogoutController</abbr>](classes/NPR-One-Controllers-LogoutController.html)</dt><dd>This controller should always be used by every consumer, regardless of whether you are using the `authorization\_code` or `device\_code` grant types. Use this to fully log out users by revoking their `access\_token` and `refresh\_token` from the NPR authorization server and then deleting the reference to the refresh token in the secure cookie or other secure storage provider.</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-controllers-logoutcontroller.html#top) </main> <script>
        cssVars({});
