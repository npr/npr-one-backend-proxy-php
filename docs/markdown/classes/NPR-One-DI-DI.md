...
- [One](namespaces/npr-one.html)
- [DI](namespaces/npr-one-di.html)
 
 <article class="phpdocumentor-element -class"> DI <div class="phpdocumentor-element__package"> in package - [NPR](packages/NPR.html)
- [One](packages/NPR-One.html)
- [DI](packages/NPR-One-DI.html)
 
 </div> 
-----------------------------------------------------------------------------------------------------------------------------------------------------------------

<div class="phpdocumentor-label-line"></div> <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/DI/DI.php">[<abbr title="src/DI/DI.php">DI.php</abbr>](files/src-di-di.html)</abbr> : <span class="phpdocumentor-element-found-in__line">17</span> </aside>Sets up a dependency injection container for the project, to enable better isolation in unit tests

###  Table of Contents [](classes/NPR-One-DI-DI.html#toc)

####  Methods [](classes/NPR-One-DI-DI.html#toc-methods)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [container()](classes/NPR-One-DI-DI.html#method_container) <span> : <abbr title="\DI\Container">Container</abbr> </span></dt><dd>Returns a dependency injection container for the project, creating one if it does not already exist.</dd> </dl> <section class="phpdocumentor-methods">###  Methods [](classes/NPR-One-DI-DI.html#methods) 

 <article class="phpdocumentor-element
            -method
            -public
                                    -static                    ">####  container() [](classes/NPR-One-DI-DI.html#method_container) 

 <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/DI/DI.php">[<abbr title="src/DI/DI.php">DI.php</abbr>](files/src-di-di.html)</abbr> : <span class="phpdocumentor-element-found-in__line">28</span> </aside>Returns a dependency injection container for the project, creating one if it does not already exist.

 `    <span class="phpdocumentor-signature__visibility">public</span>            <span class="phpdocumentor-signature__static">static</span>        <span class="phpdocumentor-signature__name">container</span><span>(</span><span>)</span><span> : </span><span class="phpdocumentor-signature__response_type"><abbr title="\DI\Container">Container</abbr></span>`<div class="phpdocumentor-label-line"> </div> <section>##### Return values

 <span class="phpdocumentor-signature__response_type"><abbr title="\DI\Container">Container</abbr></span> </section></article> </section><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
- - [Methods](classes/NPR-One-DI-DI.html#toc-methods)
- Methods
- - [container()](classes/NPR-One-DI-DI.html#method_container)
...
--------------
 ...
 </section> </section></section> </div> [](classes/NPR-One-DI-DI.html#top) </main> <script>
        cssVars({});
