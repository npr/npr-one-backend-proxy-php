...
- [Controllers](namespaces/npr-one-controllers.html)
 ...
 <article class="phpdocumentor-element -class"> LogoutController <span class="phpdocumentor-element__extends"> extends <abbr title="\NPR\One\Controllers\AbstractOAuth2Controller">AbstractOAuth2Controller</abbr> </span><div class="phpdocumentor-element__package"> in package - [NPR](packages/NPR.html)
- [One](packages/NPR-One.html)
...
<div class="phpdocumentor-label-line"></div> <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Controllers/LogoutController.php">[<abbr title="src/Controllers/LogoutController.php">LogoutController.php</abbr>](files/src-controllers-logoutcontroller.html)</abbr> : <span class="phpdocumentor-element-found-in__line">18</span> </aside>This controller should always be used by every consumer, regardless of whether you are using the `authorization\_code` or `device\_code` grant types. Use this to fully log out users by revoking their `access\_token` and `refresh\_token` from the NPR authorization server and then deleting the reference to the refresh token in the secure cookie or other secure storage provider.

###  Table of Contents [](classes/NPR-One-Controllers-LogoutController.html#toc)

####  Methods [](classes/NPR-One-Controllers-LogoutController.html#toc-methods)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [deleteAccessAndRefreshTokens()](classes/NPR-One-Controllers-LogoutController.html#method_deleteAccessAndRefreshTokens) <span> : mixed </span></dt><dd>Revokes an access+refresh token pair and removes the refresh token from the secure storage layer.</dd> </dl> <section class="phpdocumentor-methods">###  Methods [](classes/NPR-One-Controllers-LogoutController.html#methods) 

 <article class="phpdocumentor-element
            -method
            -public
                                                        ">####  deleteAccessAndRefreshTokens() [](classes/NPR-One-Controllers-LogoutController.html#method_deleteAccessAndRefreshTokens) 

 <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Controllers/LogoutController.php">[<abbr title="src/Controllers/LogoutController.php">LogoutController.php</abbr>](files/src-controllers-logoutcontroller.html)</abbr> : <span class="phpdocumentor-element-found-in__line">31</span> </aside>Revokes an access+refresh token pair and removes the refresh token from the secure storage layer.

 `    <span class="phpdocumentor-signature__visibility">public</span>                    <span class="phpdocumentor-signature__name">deleteAccessAndRefreshTokens</span><span>(</span><span class="phpdocumentor-signature__argument"><span>[</span><span class="phpdocumentor-signature__argument__return-type">string|null </span><span class="phpdocumentor-signature__argument__name">$accessToken</span><span> = </span><span class="phpdocumentor-signature__argument__default-value">null</span><span> ]</span></span><span>)</span><span> : </span><span class="phpdocumentor-signature__response_type">mixed</span>`<div class="phpdocumentor-label-line"><div class="phpdocumentor-label phpdocumentor-label--success"><span>API</span><span>Yes</span></div> </div> <section class="phpdocumentor-description">By default, this takes in an access token (string); however, the access token *may* be omitted, in which case it will attempt to revoke the pair based on the refresh token previously saved to the secure storage layer. If no refresh token is found, this function will throw an exception (because there is nothing to be revoked).

</section>##### Parameters

 <dl class="phpdocumentor-argument-list"> <dt class="phpdocumentor-argument-list__entry"> <span class="phpdocumentor-signature__argument__name">$accessToken</span> : <span class="phpdocumentor-signature__argument__return-type">string|null</span> = <span class="phpdocumentor-signature__argument__default-value">null</span> </dt> <dd class="phpdocumentor-argument-list__definition"> </dd> </dl>#####  Tags [](classes/NPR-One-Controllers-LogoutController.html#method_deleteAccessAndRefreshTokens#tags) 

 <dl class="phpdocumentor-tag-list"> <dt class="phpdocumentor-tag-list__entry"> <span class="phpdocumentor-tag__name">throws</span> </dt> <dd class="phpdocumentor-tag-list__definition"> <span class="phpdocumentor-tag-link"><abbr title="\Exception">Exception</abbr></span> <section class="phpdocumentor-description">if no access token is passed in and no refresh token is found in the secure storage layer

</section> </dd> <dt class="phpdocumentor-tag-list__entry"> <span class="phpdocumentor-tag__name">throws</span> </dt> <dd class="phpdocumentor-tag-list__definition"> <span class="phpdocumentor-tag-link"><abbr title="\GuzzleHttp\Exception\GuzzleException">GuzzleException</abbr></span> </dd> </dl> </article> </section><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](classes/NPR-One-Controllers-LogoutController.html#top) </main> <script>
        cssVars({});
