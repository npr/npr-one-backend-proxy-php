...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">ApiException.php
----------------

###  Table of Contents [](files/src-exceptions-apiexception.html#toc)

####  Classes [](files/src-exceptions-apiexception.html#toc-classes) 
...
--------------
 ...
 </section> </section></section> </div> [](files/src-exceptions-apiexception.html#top) </main> <script>
        cssVars({});
