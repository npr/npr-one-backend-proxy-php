...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -package">API Documentation
-----------------

###  Table of Contents [](packages/default.html#toc)

####  Packages [](packages/default.html#packages)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -package">[<abbr title="\Application">Application</abbr>](packages/Application.html)</dt> <dt class="phpdocumentor-table-of-contents__entry -package">[<abbr title="\NPR">NPR</abbr>](packages/NPR.html)</dt> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](packages/default.html#top) </main> <script>
        cssVars({});
