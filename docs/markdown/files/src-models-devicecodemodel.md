...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">DeviceCodeModel.php
-------------------

###  Table of Contents [](files/src-models-devicecodemodel.html#toc)

####  Classes [](files/src-models-devicecodemodel.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Models\DeviceCodeModel">DeviceCodeModel</abbr>](classes/NPR-One-Models-DeviceCodeModel.html)</dt><dd>A thin wrapper around a device code/user code pair, based on the raw JSON returned from the `POST /device` endpoint.</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-models-devicecodemodel.html#top) </main> <script>
        cssVars({});
