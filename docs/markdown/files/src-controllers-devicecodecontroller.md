...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">DeviceCodeController.php
------------------------

###  Table of Contents [](files/src-controllers-devicecodecontroller.html#toc)

####  Classes [](files/src-controllers-devicecodecontroller.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Controllers\DeviceCodeController">DeviceCodeController</abbr>](classes/NPR-One-Controllers-DeviceCodeController.html)</dt><dd>Use this controller to power your OAuth2 proxy if you are using the `device\_code` grant.</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-controllers-devicecodecontroller.html#top) </main> <script>
        cssVars({});
