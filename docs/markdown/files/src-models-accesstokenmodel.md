...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">AccessTokenModel.php
--------------------

###  Table of Contents [](files/src-models-accesstokenmodel.html#toc)

####  Classes [](files/src-models-accesstokenmodel.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Models\AccessTokenModel">AccessTokenModel</abbr>](classes/NPR-One-Models-AccessTokenModel.html)</dt><dd>A thin wrapper around an access token, based on the raw JSON returned from the `POST /token` endpoint.</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-models-accesstokenmodel.html#top) </main> <script>
        cssVars({});
