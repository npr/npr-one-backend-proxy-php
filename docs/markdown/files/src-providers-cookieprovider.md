...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">CookieProvider.php
------------------

###  Table of Contents [](files/src-providers-cookieprovider.html#toc)

####  Classes [](files/src-providers-cookieprovider.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Providers\CookieProvider">CookieProvider</abbr>](classes/NPR-One-Providers-CookieProvider.html)</dt><dd>A thin wrapper around the PHP functions to get and set cookies. Useful for unit testing.</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-providers-cookieprovider.html#top) </main> <script>
        cssVars({});
