...
- [One](packages/NPR-One.html)
 ...
 <article class="phpdocumentor-element -package">Interfaces
----------

###  Table of Contents [](packages/NPR-One-Interfaces.html#toc)

####  Interfaces [](packages/NPR-One-Interfaces.html#toc-interfaces) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -interface">[<abbr title="\NPR\One\Interfaces\ConfigInterface">ConfigInterface</abbr>](classes/NPR-One-Interfaces-ConfigInterface.html)</dt><dd>Establishes a set of requirements for the configuration provider for the project</dd> <dt class="phpdocumentor-table-of-contents__entry -interface">[<abbr title="\NPR\One\Interfaces\EncryptionInterface">EncryptionInterface</abbr>](classes/NPR-One-Interfaces-EncryptionInterface.html)</dt><dd>Establishes a set of requirements for the encryption provider for the project</dd> <dt class="phpdocumentor-table-of-contents__entry -interface">[<abbr title="\NPR\One\Interfaces\StorageInterface">StorageInterface</abbr>](classes/NPR-One-Interfaces-StorageInterface.html)</dt><dd>Establishes a set of requirements for the storage provider for the project</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](packages/NPR-One-Interfaces.html#top) </main> <script>
        cssVars({});
