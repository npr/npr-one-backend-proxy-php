...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">AuthCodeController.php
----------------------

###  Table of Contents [](files/src-controllers-authcodecontroller.html#toc)

####  Classes [](files/src-controllers-authcodecontroller.html#toc-classes) 
...
--------------
 ...
 </section> </section></section> </div> [](files/src-controllers-authcodecontroller.html#top) </main> <script>
        cssVars({});
