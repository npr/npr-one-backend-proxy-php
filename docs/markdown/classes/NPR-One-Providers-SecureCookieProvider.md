...
- [Providers](namespaces/npr-one-providers.html)
 ...
 <article class="phpdocumentor-element -class"> SecureCookieProvider <span class="phpdocumentor-element__extends"> extends [<abbr title="\NPR\One\Providers\CookieProvider">CookieProvider</abbr>](classes/NPR-One-Providers-CookieProvider.html) </span><div class="phpdocumentor-element__package"> in package - [NPR](packages/NPR.html)
- [One](packages/NPR-One.html)
...
<div class="phpdocumentor-label-line"></div> <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Providers/SecureCookieProvider.php">[<abbr title="src/Providers/SecureCookieProvider.php">SecureCookieProvider.php</abbr>](files/src-providers-securecookieprovider.html)</abbr> : <span class="phpdocumentor-element-found-in__line">14</span> </aside>An extension of CookieProvider that encrypts cookies before setting them and decrypts them when retrieving them

#####  Tags [](classes/NPR-One-Providers-SecureCookieProvider.html#tags) 

 <dl class="phpdocumentor-tag-list"> <dt class="phpdocumentor-tag-list__entry"> <span class="phpdocumentor-tag__name">codeCoverageIgnore</span> </dt> <dd class="phpdocumentor-tag-list__definition"> </dd> </dl>###  Table of Contents [](classes/NPR-One-Providers-SecureCookieProvider.html#toc)

####  Methods [](classes/NPR-One-Providers-SecureCookieProvider.html#toc-methods)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [compare()](classes/NPR-One-Providers-CookieProvider.html#method_compare) <span> : bool </span></dt><dd>The provided $key should be used to lookup a value and then compare that value to the $value provided. If they match, return true. If not, false.</dd> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [get()](classes/NPR-One-Providers-SecureCookieProvider.html#method_get) <span> : string|null </span></dt><dd>Get the value of cookie by given name</dd> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [remove()](classes/NPR-One-Providers-CookieProvider.html#method_remove) <span> : mixed </span></dt><dd>Removes the cookie if one exists</dd> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [set()](classes/NPR-One-Providers-SecureCookieProvider.html#method_set) <span> : mixed </span></dt><dd>Sets a cookie value for the given name</dd> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [setDomain()](classes/NPR-One-Providers-CookieProvider.html#method_setDomain) <span> : mixed </span></dt><dd>Sets the domain to use for the cookies.</dd> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [setEncryptionProvider()](classes/NPR-One-Providers-SecureCookieProvider.html#method_setEncryptionProvider) <span> : mixed </span></dt><dd>Sets the encryption provider that will be used to encrypt cookies before setting them and decrypt cookies when retrieving them.</dd> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [setKeyPrefix()](classes/NPR-One-Providers-CookieProvider.html#method_setKeyPrefix) <span> : mixed </span></dt><dd>If you have multiple proxies living on one server and are using the same cookie domain, you may need to be able to use a prefix to differentiate between them. Use this function in that case.</dd> </dl> <section class="phpdocumentor-methods">###  Methods [](classes/NPR-One-Providers-SecureCookieProvider.html#methods) 
 ...
 <span class="phpdocumentor-signature__response_type">bool</span> </section></article> <article class="phpdocumentor-element
            -method
            -public
                                                        ">####  get() [](classes/NPR-One-Providers-SecureCookieProvider.html#method_get) 

 <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Providers/SecureCookieProvider.php">[<abbr title="src/Providers/SecureCookieProvider.php">SecureCookieProvider.php</abbr>](files/src-providers-securecookieprovider.html)</abbr> : <span class="phpdocumentor-element-found-in__line">44</span> </aside>Get the value of cookie by given name

 `    <span class="phpdocumentor-signature__visibility">public</span>                    <span class="phpdocumentor-signature__name">get</span><span>(</span><span class="phpdocumentor-signature__argument"><span class="phpdocumentor-signature__argument__return-type">mixed </span><span class="phpdocumentor-signature__argument__name">$key</span></span><span>)</span><span> : </span><span class="phpdocumentor-signature__response_type">string|null</span>`<div class="phpdocumentor-label-line"> </div>##### Parameters

 <dl class="phpdocumentor-argument-list"> <dt class="phpdocumentor-argument-list__entry"> <span class="phpdocumentor-signature__argument__name">$key</span> : <span class="phpdocumentor-signature__argument__return-type">mixed</span> </dt> <dd class="phpdocumentor-argument-list__definition"> </dd> </dl> <section>##### Return values
 ...
 <dl class="phpdocumentor-tag-list"> <dt class="phpdocumentor-tag-list__entry"> <span class="phpdocumentor-tag__name">codeCoverageIgnore</span> </dt> <dd class="phpdocumentor-tag-list__definition"> </dd> </dl> </article> <article class="phpdocumentor-element
            -method
            -public
                                                        ">####  set() [](classes/NPR-One-Providers-SecureCookieProvider.html#method_set) 

 <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Providers/SecureCookieProvider.php">[<abbr title="src/Providers/SecureCookieProvider.php">SecureCookieProvider.php</abbr>](files/src-providers-securecookieprovider.html)</abbr> : <span class="phpdocumentor-element-found-in__line">35</span> </aside>Sets a cookie value for the given name

 `    <span class="phpdocumentor-signature__visibility">public</span>                    <span class="phpdocumentor-signature__name">set</span><span>(</span><span class="phpdocumentor-signature__argument"><span class="phpdocumentor-signature__argument__return-type">mixed </span><span class="phpdocumentor-signature__argument__name">$key</span></span><span class="phpdocumentor-signature__argument"><span>, </span><span class="phpdocumentor-signature__argument__return-type">mixed </span><span class="phpdocumentor-signature__argument__name">$value</span></span><span class="phpdocumentor-signature__argument"><span>[</span><span>, </span><span class="phpdocumentor-signature__argument__return-type">mixed </span><span class="phpdocumentor-signature__argument__name">$expiresIn</span><span> = </span><span class="phpdocumentor-signature__argument__default-value">null</span><span> ]</span></span><span>)</span><span> : </span><span class="phpdocumentor-signature__response_type">mixed</span>`<div class="phpdocumentor-label-line"> </div>##### Parameters

 <dl class="phpdocumentor-argument-list"> <dt class="phpdocumentor-argument-list__entry"> <span class="phpdocumentor-signature__argument__name">$key</span> : <span class="phpdocumentor-signature__argument__return-type">mixed</span> </dt> <dd class="phpdocumentor-argument-list__definition"> </dd> <dt class="phpdocumentor-argument-list__entry"> <span class="phpdocumentor-signature__argument__name">$value</span> : <span class="phpdocumentor-signature__argument__return-type">mixed</span> </dt> <dd class="phpdocumentor-argument-list__definition"> </dd> <dt class="phpdocumentor-argument-list__entry"> <span class="phpdocumentor-signature__argument__name">$expiresIn</span> : <span class="phpdocumentor-signature__argument__return-type">mixed</span> = <span class="phpdocumentor-signature__argument__default-value">null</span> </dt> <dd class="phpdocumentor-argument-list__definition"> </dd> </dl> </article> <article class="phpdocumentor-element
            -method
            -public
 ...
 <dl class="phpdocumentor-tag-list"> <dt class="phpdocumentor-tag-list__entry"> <span class="phpdocumentor-tag__name">throws</span> </dt> <dd class="phpdocumentor-tag-list__definition"> <span class="phpdocumentor-tag-link"><abbr title="\InvalidArgumentException">InvalidArgumentException</abbr></span> <section class="phpdocumentor-description">if the passed-in value is not either a non-empty string, or null
            ...
            -method
            -public
                                                        ">####  setEncryptionProvider() [](classes/NPR-One-Providers-SecureCookieProvider.html#method_setEncryptionProvider) 

 <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Providers/SecureCookieProvider.php">[<abbr title="src/Providers/SecureCookieProvider.php">SecureCookieProvider.php</abbr>](files/src-providers-securecookieprovider.html)</abbr> : <span class="phpdocumentor-element-found-in__line">27</span> </aside>Sets the encryption provider that will be used to encrypt cookies before setting them and decrypt cookies when retrieving them.

 `    <span class="phpdocumentor-signature__visibility">public</span>                    <span class="phpdocumentor-signature__name">setEncryptionProvider</span><span>(</span><span class="phpdocumentor-signature__argument"><span class="phpdocumentor-signature__argument__return-type"><a href="classes/NPR-One-Interfaces-EncryptionInterface.html"><abbr title="\NPR\One\Interfaces\EncryptionInterface">EncryptionInterface</abbr></a> </span><span class="phpdocumentor-signature__argument__name">$encryptionProvider</span></span><span>)</span><span> : </span><span class="phpdocumentor-signature__response_type">mixed</span>`<div class="phpdocumentor-label-line"> </div>##### Parameters

 <dl class="phpdocumentor-argument-list"> <dt class="phpdocumentor-argument-list__entry"> <span class="phpdocumentor-signature__argument__name">$encryptionProvider</span> : <span class="phpdocumentor-signature__argument__return-type">[<abbr title="\NPR\One\Interfaces\EncryptionInterface">EncryptionInterface</abbr>](classes/NPR-One-Interfaces-EncryptionInterface.html)</span> </dt> <dd class="phpdocumentor-argument-list__definition"> </dd> </dl> </article> <article class="phpdocumentor-element
            -method
            -public
...
--------------
 ...
 </section> </section></section> </div> [](classes/NPR-One-Providers-SecureCookieProvider.html#top) </main> <script>
        cssVars({});
