...
- [One](packages/NPR-One.html)
 ...
 <article class="phpdocumentor-element -package">Models
------

###  Table of Contents [](packages/NPR-One-Models.html#toc)

####  Classes [](packages/NPR-One-Models.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Models\AccessTokenModel">AccessTokenModel</abbr>](classes/NPR-One-Models-AccessTokenModel.html)</dt><dd>A thin wrapper around an access token, based on the raw JSON returned from the `POST /token` endpoint.</dd> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Models\DeviceCodeModel">DeviceCodeModel</abbr>](classes/NPR-One-Models-DeviceCodeModel.html)</dt><dd>A thin wrapper around a device code/user code pair, based on the raw JSON returned from the `POST /device` endpoint.</dd> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Models\JsonModel">JsonModel</abbr>](classes/NPR-One-Models-JsonModel.html)</dt><dd>A thin abstraction to aide in transforming raw JSON into a model, yet allowing it to be re-encoded as JSON when stringified.</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](packages/NPR-One-Models.html#top) </main> <script>
        cssVars({});
