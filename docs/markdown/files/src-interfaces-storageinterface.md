...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">StorageInterface.php
--------------------

###  Table of Contents [](files/src-interfaces-storageinterface.html#toc)

####  Interfaces [](files/src-interfaces-storageinterface.html#toc-interfaces) 
...
--------------
 ...
 </section> </section></section> </div> [](files/src-interfaces-storageinterface.html#top) </main> <script>
        cssVars({});
