...
- [Controllers](namespaces/npr-one-controllers.html)
 ...
 <article class="phpdocumentor-element -class"> RefreshTokenController <span class="phpdocumentor-element__extends"> extends <abbr title="\NPR\One\Controllers\AbstractOAuth2Controller">AbstractOAuth2Controller</abbr> </span><div class="phpdocumentor-element__package"> in package - [NPR](packages/NPR.html)
- [One](packages/NPR-One.html)
...
<div class="phpdocumentor-label-line"></div> <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Controllers/RefreshTokenController.php">[<abbr title="src/Controllers/RefreshTokenController.php">RefreshTokenController.php</abbr>](files/src-controllers-refreshtokencontroller.html)</abbr> : <span class="phpdocumentor-element-found-in__line">16</span> </aside>This controller should always be used by every consumer, regardless of whether you are using the `authorization\_code` or `device\_code` grant types. Use this to generate a new access token when a previously-generated token has expired.

 <section class="phpdocumentor-description">The consumer of this codebase is responsible for setting up a router which forwards on the relevant requests to the [<abbr title="\NPR\One\Controllers\RefreshTokenController::generateNewAccessTokenFromRefreshToken()">RefreshTokenController::generateNewAccessTokenFromRefreshToken()</abbr>](classes/NPR-One-Controllers-RefreshTokenController.html#method_generateNewAccessTokenFromRefreshToken) public method in this class.

</section>###  Table of Contents [](classes/NPR-One-Controllers-RefreshTokenController.html#toc)

####  Methods [](classes/NPR-One-Controllers-RefreshTokenController.html#toc-methods)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [generateNewAccessTokenFromRefreshToken()](classes/NPR-One-Controllers-RefreshTokenController.html#method_generateNewAccessTokenFromRefreshToken) <span> : [<abbr title="\NPR\One\Models\AccessTokenModel">AccessTokenModel</abbr>](classes/NPR-One-Models-AccessTokenModel.html) </span></dt><dd>Attempts to locate a refresh token securely stored in the cookies and, if found, generates a new access token.</dd> </dl> <section class="phpdocumentor-methods">###  Methods [](classes/NPR-One-Controllers-RefreshTokenController.html#methods) 

 <article class="phpdocumentor-element
            -method
            -public
                                                        ">####  generateNewAccessTokenFromRefreshToken() [](classes/NPR-One-Controllers-RefreshTokenController.html#method_generateNewAccessTokenFromRefreshToken) 

 <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Controllers/RefreshTokenController.php">[<abbr title="src/Controllers/RefreshTokenController.php">RefreshTokenController.php</abbr>](files/src-controllers-refreshtokencontroller.html)</abbr> : <span class="phpdocumentor-element-found-in__line">27</span> </aside>Attempts to locate a refresh token securely stored in the cookies and, if found, generates a new access token.

 `    <span class="phpdocumentor-signature__visibility">public</span>                    <span class="phpdocumentor-signature__name">generateNewAccessTokenFromRefreshToken</span><span>(</span><span>)</span><span> : </span><span class="phpdocumentor-signature__response_type"><a href="classes/NPR-One-Models-AccessTokenModel.html"><abbr title="\NPR\One\Models\AccessTokenModel">AccessTokenModel</abbr></a></span>`<div class="phpdocumentor-label-line"><div class="phpdocumentor-label phpdocumentor-label--success"><span>API</span><span>Yes</span></div> </div>#####  Tags [](classes/NPR-One-Controllers-RefreshTokenController.html#method_generateNewAccessTokenFromRefreshToken#tags) 
 ...
 <span class="phpdocumentor-signature__response_type">[<abbr title="\NPR\One\Models\AccessTokenModel">AccessTokenModel</abbr>](classes/NPR-One-Models-AccessTokenModel.html)</span> </section></article> </section><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](classes/NPR-One-Controllers-RefreshTokenController.html#top) </main> <script>
        cssVars({});
