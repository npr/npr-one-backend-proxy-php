...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -namespace">API Documentation
-----------------

###  Table of Contents [](namespaces/default.html#toc)

####  Namespaces [](namespaces/default.html#namespaces)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -namespace">[<abbr title="\NPR">NPR</abbr>](namespaces/npr.html)</dt> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](namespaces/default.html#top) </main> <script>
        cssVars({});
