...
- [Models](namespaces/npr-one-models.html)
 ...
 <article class="phpdocumentor-element -class"> JsonModel <div class="phpdocumentor-element__package"> in package - [NPR](packages/NPR.html)
- [One](packages/NPR-One.html)
...
<div class="phpdocumentor-label-line"><div class="phpdocumentor-label phpdocumentor-label--success"><span>Abstract</span><span>Yes</span></div></div> <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Models/JsonModel.php">[<abbr title="src/Models/JsonModel.php">JsonModel.php</abbr>](files/src-models-jsonmodel.html)</abbr> : <span class="phpdocumentor-element-found-in__line">12</span> </aside>A thin abstraction to aide in transforming raw JSON into a model, yet allowing it to be re-encoded as JSON when stringified.

###  Table of Contents [](classes/NPR-One-Models-JsonModel.html#toc)

####  Methods [](classes/NPR-One-Models-JsonModel.html#toc-methods)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [\_\_construct()](classes/NPR-One-Models-JsonModel.html#method___construct) <span> : mixed </span></dt><dd>Model constructor.</dd> <dt class="phpdocumentor-table-of-contents__entry -method -public"> [\_\_toString()](classes/NPR-One-Models-JsonModel.html#method___toString) <span> : string </span></dt><dd>Re-encodes the original JSON model as a string and returns it.</dd> </dl> <section class="phpdocumentor-methods">###  Methods [](classes/NPR-One-Models-JsonModel.html#methods) 

 <article class="phpdocumentor-element
            -method
            -public
                                                        ">####  \_\_construct() [](classes/NPR-One-Models-JsonModel.html#method___construct) 

 <aside class="phpdocumentor-element-found-in"> <abbr class="phpdocumentor-element-found-in__file" title="src/Models/JsonModel.php">[<abbr title="src/Models/JsonModel.php">JsonModel.php</abbr>](files/src-models-jsonmodel.html)</abbr> : <span class="phpdocumentor-element-found-in__line">24</span> </aside>Model constructor.
 ...
 <dl class="phpdocumentor-argument-list"> <dt class="phpdocumentor-argument-list__entry"> <span class="phpdocumentor-signature__argument__name">$json</span> : <span class="phpdocumentor-signature__argument__return-type">mixed</span> </dt> <dd class="phpdocumentor-argument-list__definition"> </dd> </dl>#####  Tags [](classes/NPR-One-Models-JsonModel.html#method___construct#tags) 
...
--------------
 ...
 </section> </section></section> </div> [](classes/NPR-One-Models-JsonModel.html#top) </main> <script>
        cssVars({});
