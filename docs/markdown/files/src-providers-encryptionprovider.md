...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">EncryptionProvider.php
----------------------

###  Table of Contents [](files/src-providers-encryptionprovider.html#toc)

####  Classes [](files/src-providers-encryptionprovider.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Providers\EncryptionProvider">EncryptionProvider</abbr>](classes/NPR-One-Providers-EncryptionProvider.html)</dt><dd>A sample encryption provider, used in tandem with the SecureCookieProvider as the default implementation for secure storage of refresh tokens.</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-providers-encryptionprovider.html#top) </main> <script>
        cssVars({});
