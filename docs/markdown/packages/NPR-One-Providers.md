...
- [One](packages/NPR-One.html)
 ...
 <article class="phpdocumentor-element -package">Providers
---------

###  Table of Contents [](packages/NPR-One-Providers.html#toc)

####  Classes [](packages/NPR-One-Providers.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Providers\CookieProvider">CookieProvider</abbr>](classes/NPR-One-Providers-CookieProvider.html)</dt><dd>A thin wrapper around the PHP functions to get and set cookies. Useful for unit testing.</dd> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Providers\EncryptionProvider">EncryptionProvider</abbr>](classes/NPR-One-Providers-EncryptionProvider.html)</dt><dd>A sample encryption provider, used in tandem with the SecureCookieProvider as the default implementation for secure storage of refresh tokens.</dd> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Providers\SecureCookieProvider">SecureCookieProvider</abbr>](classes/NPR-One-Providers-SecureCookieProvider.html)</dt><dd>An extension of CookieProvider that encrypts cookies before setting them and decrypts them when retrieving them</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](packages/NPR-One-Providers.html#top) </main> <script>
        cssVars({});
