...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -namespace">NPR
---

###  Table of Contents [](namespaces/npr.html#toc)

####  Namespaces [](namespaces/npr.html#namespaces)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -namespace">[<abbr title="\NPR\One">One</abbr>](namespaces/npr-one.html)</dt> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](namespaces/npr.html#top) </main> <script>
        cssVars({});
