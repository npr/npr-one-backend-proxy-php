...
### [Files](indices/files.html)
 ...
 </section></aside><div class="phpdocumentor-column -nine phpdocumentor-content"> <section>Documentation
-------------

###  Table of Contents [](namespaces/default.html#toc)

####  Packages [](namespaces/default.html#packages)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -package">[<abbr title="\Application">Application</abbr>](packages/Application.html)</dt> <dt class="phpdocumentor-table-of-contents__entry -package">[<abbr title="\NPR">NPR</abbr>](packages/NPR.html)</dt> </dl>####  Namespaces [](namespaces/default.html#namespaces)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -namespace">[<abbr title="\NPR">NPR</abbr>](namespaces/npr.html)</dt> </dl> </section> </div> <section class="phpdocumentor-search-results phpdocumentor-search-results--hidden" data-search-results=""> <section class="phpdocumentor-search-results__dialog"> <header class="phpdocumentor-search-results__header">Search results
--------------

 <button class="phpdocumentor-search-results__close"></button> </header> <section class="phpdocumentor-search-results__body">
 </section> </section></section> </div> [](index.html#top) </main> <script>
        cssVars({});
