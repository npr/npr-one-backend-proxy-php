...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">EncryptionInterface.php
-----------------------

###  Table of Contents [](files/src-interfaces-encryptioninterface.html#toc)

####  Interfaces [](files/src-interfaces-encryptioninterface.html#toc-interfaces) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -interface">[<abbr title="\NPR\One\Interfaces\EncryptionInterface">EncryptionInterface</abbr>](classes/NPR-One-Interfaces-EncryptionInterface.html)</dt><dd>Establishes a set of requirements for the encryption provider for the project</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-interfaces-encryptioninterface.html#top) </main> <script>
        cssVars({});
