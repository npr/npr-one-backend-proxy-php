...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">AbstractOAuth2Controller.php
----------------------------

###  Table of Contents [](files/src-controllers-abstractoauth2controller.html#toc)

<div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-controllers-abstractoauth2controller.html#top) </main> <script>
        cssVars({});
