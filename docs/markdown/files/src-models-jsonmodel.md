...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -file">JsonModel.php
-------------

###  Table of Contents [](files/src-models-jsonmodel.html#toc)

####  Classes [](files/src-models-jsonmodel.html#toc-classes) 

 <dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -class">[<abbr title="\NPR\One\Models\JsonModel">JsonModel</abbr>](classes/NPR-One-Models-JsonModel.html)</dt><dd>A thin abstraction to aide in transforming raw JSON into a model, yet allowing it to be re-encoded as JSON when stringified.</dd> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](files/src-models-jsonmodel.html#top) </main> <script>
        cssVars({});
