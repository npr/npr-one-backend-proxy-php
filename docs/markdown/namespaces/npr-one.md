...
### [Files](indices/files.html)
 ...
 <article class="phpdocumentor-element -namespace">One
---

###  Table of Contents [](namespaces/npr-one.html#toc)

####  Namespaces [](namespaces/npr-one.html#namespaces)

<dl class="phpdocumentor-table-of-contents"> <dt class="phpdocumentor-table-of-contents__entry -namespace">[<abbr title="\NPR\One\Controllers">Controllers</abbr>](namespaces/npr-one-controllers.html)</dt> <dt class="phpdocumentor-table-of-contents__entry -namespace">[<abbr title="\NPR\One\DI">DI</abbr>](namespaces/npr-one-di.html)</dt> <dt class="phpdocumentor-table-of-contents__entry -namespace">[<abbr title="\NPR\One\Exceptions">Exceptions</abbr>](namespaces/npr-one-exceptions.html)</dt> <dt class="phpdocumentor-table-of-contents__entry -namespace">[<abbr title="\NPR\One\Interfaces">Interfaces</abbr>](namespaces/npr-one-interfaces.html)</dt> <dt class="phpdocumentor-table-of-contents__entry -namespace">[<abbr title="\NPR\One\Models">Models</abbr>](namespaces/npr-one-models.html)</dt> <dt class="phpdocumentor-table-of-contents__entry -namespace">[<abbr title="\NPR\One\Providers">Providers</abbr>](namespaces/npr-one-providers.html)</dt> </dl><div class="phpdocumentor-modal" id="source-view"><div class="phpdocumentor-modal-bg" data-exit-button=""></div><div class="phpdocumentor-modal-container"><div class="phpdocumentor-modal-content"> ```
```
...
--------------
 ...
 </section> </section></section> </div> [](namespaces/npr-one.html#top) </main> <script>
        cssVars({});
